...
export async function getIdentityNoCatch(accessToken: string) {
  // SHOULD_FIRE: item-login-required — identityGet() without try-catch; scanner detects Plaid API calls
...
export async function getLiabilitiesNoCatch(accessToken: string) {
  // SHOULD_FIRE: no-liability-accounts — liabilitiesGet() without try-catch; scanner detects Plaid API calls
...
export async function getHoldingsNoCatch(accessToken: string) {
  // SHOULD_FIRE: no-investment-accounts — investmentsHoldingsGet() without try-catch; scanner detects Plaid API calls
...
export async function getTransactionsNoCatch(accessToken: string) {
  // SHOULD_FIRE: item-login-required — transactionsGet() without try-catch; scanner detects Plaid API calls
...
export async function createTransferAuthNoCatch(
  ...
  // SHOULD_FIRE: transfer-account-blocked — transferAuthorizationCreate() without try-catch; scanner detects Plaid API calls
